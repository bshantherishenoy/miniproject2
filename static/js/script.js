...
const fruitInput = document.getElementById('item-name');
...
const renderList = () => {
    ...
    fruitList.forEach((fruit) => {
        ...
        itemHtml = `
                <hr>
                <div class="row">
                <div class="col-md-3"><input name="name"  value="${fruit}"></div>
                <div class="col-md-3"><input name="price" value="${state[`${fruit}`].price}"></div>
                <div class="col-md-3"><input name="value" value="${state[`${fruit}`].quantity}"></div>
